...
int tree::lhsdiag(char aiplayer){
    int value = 0;
    char me = aiplayer;
...
int tree::rhsdiag(char aiplayer){
    int value = 0;
    char me = aiplayer;
    char opp = ReversePlayer(aiplayer);
    char blank = ' ';
...
int tree::horizontal(char aiplayer){
    int value = 0;
    char me = aiplayer;
    char opp = ReversePlayer(aiplayer);
    char blank = ' ';
...
int tree::vertical(char aiplayer){
    int value = 0;
    char me = aiplayer;
    char opp = ReversePlayer(aiplayer);
    char blank = ' ';
...
int tree::evaluation_m(char aiplayer){
    
    int temp = 0;
    int value = 0;
    
    temp = lhsdiag(aiplayer);
    if(temp == INT_MIN || temp == INT_MAX)
        return temp;
    value += temp;
    
    temp = rhsdiag(aiplayer);
    if(temp == INT_MIN || temp == INT_MAX)
        return temp;
    value += temp;
    
    temp = horizontal(aiplayer);
    if(temp == INT_MIN || temp == INT_MAX)
        return temp;
    value += temp;
    
    temp = vertical(aiplayer);
    if(temp == INT_MIN || temp == INT_MAX)
        return temp;
    value += temp;
